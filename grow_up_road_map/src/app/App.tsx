    ...
    >
      ...
      <button
        ...
        style={{
          ...
          padding: "14px 24px",
          borderRadius: 9999,
          border: `2px solid ${isParentMode ? "rgba(255,255,255,0.2)" : "#FF7A64"}`,
          background: isParentMode
            ? "rgba(255,255,255,0.07)"
            : "rgba(255,122,100,0.12)",
          color: isParentMode
          ...
          letterSpacing: 0.2,
          boxShadow: isParentMode
            ? "none"
            : "0 0 0 6px rgba(255,122,100,0.1)",
        }}
        onMouseEnter={(e) => {
          const btn = e.currentTarget;
          btn.style.background = isParentMode
            ? "rgba(255,255,255,0.12)"
            : "#FF7A64";
          btn.style.color = isParentMode
      ...
      {isParentMode ? (
        ...
        <>
          ...
          >
            ...
            >
              Follow the highlighted road and click any building
              to discover what you'll learn at each stop
            </p>
          </header>
